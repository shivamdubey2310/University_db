...
1. **General Elements**
   ...
   5. **Description**: Unique identifier for each major program
...
1. **General Elements**
   ...
   3. **Alias(es)**: None
   4. **Shared By**: None
   5. **Description**: Official name of the major program
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
...
1. **General Elements**
   ...
   5. **Description**: Foreign key referencing the department offering the major
   6. **Specification Type**:
      1. [ ] Unique
      2. [ ] Generic
      3. [x] Replica
