...
1. **General Elements**
   ...
   2. **Parent Table**: Student_Addresses
   3. **Alias(es)**: None
   4. **Shared By**: None
   5. **Description**: Unique identifier for each address record
...
1. **General Elements**
   ...
   5. **Description**: Foreign key referencing the student this address belongs to
   6. **Specification Type**:
      1. [ ] Unique
      2. [ ] Generic
      3. [x] Replica
...
1. **General Elements**
   ...
   3. **Alias(es)**: None
   4. **Shared By**: None
   5. **Description**: Street number part of the address
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
...
### Street_Name
1. **General Elements**
   1. **Field Name**: Street_Name
   2. **Parent Table**: Student_Addresses
   3. **Alias(es)**: None
   4. **Shared By**: None
   5. **Description**: Street name part of the address
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
...
1. **General Elements**
   ...
   3. **Alias(es)**: None
   4. **Shared By**: None
   5. **Description**: City part of the address
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
...
1. **General Elements**
   ...
   3. **Alias(es)**: Zip Code
   4. **Shared By**: None
   5. **Description**: Postal code part of the address
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
...
### State_Province
1. **General Elements**
   1. **Field Name**: State_Province
   2. **Parent Table**: Student_Addresses
   3. **Alias(es)**: State
   4. **Shared By**: None
   5. **Description**: State or province part of the address
   6. **Specification Type**:
      1. [ ] Unique
      2. [x] Generic
      3. [ ] Replica
